...
PAGES = {
    ...
    'campus/facilities.html': {
        ...
        'hero_title': 'Facilities pages should show the spaces students actually use every day.',
    ...
    'placements/success-stories.html': {
        ...
        'hero_image': 'https://sseptp.org/assets/recruiters-B_A9F7qO.png',
        'content': [
            {'type': 'story_cards', 'kicker': 'Outcome lens', 'title': 'Three published placement signals carry this page.', 'items': [('High-value offers', 'The current site already highlights strong top-end packages.'), ('Broad recruiter base', 'The number of recruiting companies matters because it signals scale, not just a few standout cases.'), ('Training-to-offer logic', 'Success stories connect back to the placement training model rather than reading like isolated testimonials.')]},
