...
def render_custom_sections(page_path: str) -> str:
    ...
    if page_path == 'academics/programs.html':
        return f'''<section class="section"><div class="container"><p class="section-label">Department map</p><div class="section-head"><h2>Programs should establish academic range quickly.</h2><p>The department overview works best when it shows both breadth and recognisable pathways, not just a wall of names.</p></div><div class="cards cols-4 academic-program-grid"><article class="card"><div class="icon">CS</div><h3>Computer Science</h3><p>Programming, software, AI/ML, databases, networks, and RIT alignment.</p></article><article class="card"><div class="icon">EC</div><h3>Electronics & Communication</h3><p>Communication systems, embedded systems, and signal-oriented engineering.</p></article><article class="card"><div class="icon">EE</div><h3>Electrical & Electronics</h3><p>Power, control, and core electrical engineering depth.</p></article><article class="card"><div class="icon">CV</div><h3>Civil / Mechanical / IT</h3><p>Infrastructure, manufacturing, and applied computing breadth across the school.</p></article></div></div></section>'''
