...
def render_custom_sections(page_path: str) -> str:
    ...
    if page_path == 'academics/labs.html':
        return f'''<section class="section"><div class="container academic-spotlight"><div class="academic-spotlight-copy"><p class="section-label">Practical infrastructure</p><h2>Labs are one of the clearest academic proof points.</h2><p>The published lab story is already strong: programming, databases, networks, VLSI, electrical machines, manufacturing, structures, geotechnics, and more.</p><ul class="mini-list"><li>CSE labs across programming, databases, AI/ML, and networks</li><li>ECE / EEE labs across communication, VLSI, machines, power, and control</li><li>Civil and mechanical labs broadening the practical learning picture</li></ul></div><div class="contact-panel"><h3>Why it matters</h3><p>Hands-on depth</p><p>Practical academic proof</p><p>Stronger program credibility</p></div></div></section>'''
