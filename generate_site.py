...
PAGES = {
    ...
    'academics/programs.html': {
        ...
        'hero_title': 'B.Tech programmes need real academic detail, not just a list of names.',
        'hero_text': 'The current SSETP site publishes five distinct undergraduate engineering programmes with clear seats, eligibility, labs, course structure, and career outcomes. That depth should be visible here too.',
        'hero_image': 'https://sseptp.org/assets/ssecampus-tJIhAnGN.jpg',
        'content': [],
    },
    'academics/labs.html': {
...
def render_hero(page_path: str, cfg: dict) -> str:
    ...
    if page_path in {'about/vision-mission.html','about/leadership.html','about/quality.html','about/industry-interface.html'}:
        labels = {
            'about/vision-mission.html': ('Vision focus', 'Purpose, values, and student-development intent should feel like institutional direction, not filler copy.'),
            'about/leadership.html': ('Leadership focus', 'Leadership pages work best when they read as human institutional voice rather than ceremonial placeholders.'),
            'about/quality.html': ('Quality focus', 'Recognition matters when it feels verifiable, grouped, and easy to understand.'),
            'about/industry-interface.html': ('Industry focus', 'Industry linkage should read as academic relevance and employability proof, not decoration.')
        }
        cta = {
    ...
    if page_path in {'academics/programs.html','academics/labs.html','academics/scholarships.html','academics/rit.html'}:
        labels = {
            'academics/programs.html': ('Program map', 'Departments and pathways should be easy to scan before the user drops into detail.'),
            ...
            'academics/scholarships.html': ('Student support', 'Scholarship visibility should reinforce confidence and access, not sit as a side note.'),
            'academics/rit.html': ('International differentiator', 'RIT should look like a flagship pathway with visible structure and academic purpose.')
        }
        cta = {
    ...
    if page_path in {'campus/facilities.html','campus/hostel.html','campus/health-safety.html','campus/sports.html'}:
        labels = {
            'campus/facilities.html': ('Practical campus support', 'Facilities pages should help families picture how students actually study and live on campus.'),
            'campus/hostel.html': ('Residential trust', 'Hostel life becomes credible when rooms, dining, community, and rules stay specific.'),
            'campus/health-safety.html': ('Calm reassurance', 'Health and safety pages should reduce uncertainty with concrete signals and direct routes.'),
    ...
    if page_path in {'placements/success-stories.html','placements/contact.html'}:
        labels = {
            'placements/success-stories.html': ('Outcome proof', 'Success pages should stay grounded in packages, recruiter range, and training-to-offer logic.'),
            'placements/contact.html': ('Recruiter route', 'Employer-facing contact should be direct, visible, and tied closely to the placement story.')
        }
        card_label, card_text = labels[page_path]
