...
PAGES = {
    ...
    'about/index.html': {
        ...
        'hero_stats': [('Puttaparthi', 'Institutional home and identity'), ('A Grade', 'NAAC accreditation highlighted by the institution'), ('3.17/4', 'NAAC score highlighted by the institution'), ('5', 'core About journeys brought into one structure')],
        'hero_image': 'https://sseptp.org/assets/outside-CBfboUlb.jpg',
        'content': [
            {'type': 'spotlight', 'kicker': 'Institutional profile', 'title': 'SSETP brings location, leadership, recognition, and academic direction into one institutional story.', 'text': 'The About section covers mission, leadership, quality systems, and industry relevance. Grouped together, those pieces give a clearer picture of what the institution stands for.', 'image': 'https://sseptp.org/assets/ChairmanMessage-7pVMSzx5.jpg', 'image_alt': 'SSETP institutional leadership', 'bullets': ['Puttaparthi identity with a clear educational purpose', 'Autonomous positioning supported by visible quality signals', 'Leadership, NAAC, IQAC, and industry relevance in one narrative'], 'actions': [('View Vision & Mission', '/about/vision-mission.html', 'primary'), ('Quality & Recognition', '/about/quality.html', 'secondary')]},
            {'type': 'feature_grid', 'variant': 'showcase', 'kicker': 'Inside About', 'title': 'The institutional story is grouped around the themes central to SSETP.', 'text': 'Mission, leadership, recognition, advisory structures, and quality systems are now easier to scan as one section.', 'cards': [
                ('Vision & Mission', 'The school’s vision, mission, and student-development intent.', '/about/vision-mission.html'),
    ...
    'about/industry-interface.html': {
        ...
        'hero_text': 'SSETP names an Industry Advisory Board with members from RISE, TCS, CGI, HCLTech, Brillio, HP, Mphasis, and Capgemini. That board gives this page clear institutional substance.',
    ...
    'admissions/index.html': {
        ...
        'hero_text': 'This section brings together overview, process, fees, scholarship support, and the enquiry contacts provided by SSETP.',
    ...
    'admissions/enquiry.html': {
        ...
        'hero_title': 'Admissions contact is direct and easy to reach.',
        ...
        'content': [
            ...
            {'type': 'quote_panel', 'kicker': 'Contact data', 'title': 'enquiry@sseptp.org | info@sseptp.org | +91 9100064545 / 74545', 'text': 'The admissions contact layer uses the same contact data across hero, body, and footer.'},
        ],
    },
    'academics/index.html': {
        ...
        'hero_text': 'SSE continuously revises curriculum through departmental committees, Boards of Studies, and the Academic Council while strengthening labs, research, and industry readiness.',
        ...
        'content': [
            ...
            {'type': 'split', 'kicker': 'Academic process', 'title': 'Curriculum revision is part of the academic story.', 'text': 'SSETP explicitly references DACs, Boards of Studies, and the Academic Council. That governance detail signals structured academic review.', 'bullets': ['Departments review and discuss syllabus content', 'Board of Studies finalizes course structure and syllabus', 'Academic Council approves broader academic matters', 'Infrastructure and research are framed as part of academic quality']},
        ],
    },
    'academics/programs.html': {
        ...
        'hero_text': 'SSETP presents five undergraduate engineering programmes with seats, eligibility, labs, course structure, and career outcomes. That detail is carried into this page.',
    ...
    'academics/labs.html': {
        ...
        'hero_text': 'SSETP presents a deep laboratory story across departments, from programming and networking labs to VLSI, manufacturing, structures, and power systems.',
        'hero_image': 'https://sseptp.org/assets/computerLabFocused-CXPA2eOi.jpg',
        'content': [
            {'type': 'story_cards', 'kicker': 'Laboratory examples', 'title': 'The lab story covers department-wise facilities.', 'items': [('CSE labs', 'Programming, databases, computer networks, and AI / machine learning are explicitly called out.'), ('ECE / EEE labs', 'Digital electronics, communication systems, VLSI, electrical machines, power systems, and control labs are part of the institutional lab story.'), ('Core engineering labs', 'Mechanical, civil, manufacturing, structural, geotechnical, and environmental labs broaden the practical picture.')]},
    ...
    'academics/scholarships.html': {
        ...
        'hero_text': 'The Sai Prudent Scholarship is one of the more concrete support stories at SSETP and stays visible here from both academics and admissions.',
        'hero_image': 'https://sseptp.org/assets/Saipriya-Ca1D8LTw.jpeg',
        'content': [
            {'type': 'story_cards', 'kicker': 'Key facts', 'title': 'What SSETP states clearly.', 'items': [('Purpose', 'Support deserving students from economically disadvantaged backgrounds.'), ('Partners', 'Supported by Anahata Stiftung and RISE, Austria according to SSETP.'), ('Selection logic', 'Academic merit, need, attendance, conduct, and participation are part of the eligibility story.')]},
    ...
    'campus/hostel.html': {
        ...
        'hero_text': 'SSETP gives hostel-specific detail on boys and girls blocks, common rooms, Wi-Fi, dining, security, activities, and rules.',
        ...
        'content': [
            ...
            {'type': 'story_cards', 'kicker': 'Concrete hostel points', 'title': 'The page already has trust-building detail.', 'items': [('24×7 security', 'Security is explicitly part of the hostel presentation.'), ('Common spaces', 'Common rooms and shared facilities make the residential environment feel more real.'), ('Dining support', 'Mess and meal arrangements are already described, so they remain prominent here.')]},
        ],
    },
    ...
    'placements/index.html': {
        ...
        'hero_text': 'SSETP presents strong placement evidence: 1675 total offers, 800 students placed, 150 recruiting companies, 36 LPA highest package, and 95% placement rate for 2024-25.',
        ...
        'content': [
            {'type': 'feature_grid', 'variant': 'showcase', 'kicker': 'Placement section', 'title': 'Placement numbers, recruiter visibility, and training routes are now grouped together.', 'text': 'SSETP has enough material to present placements as a major institutional strength.', 'cards': [('Placement Highlights', 'Published numbers, recruiter relationships, and internship visibility.', '/placements/index.html'), ('Success Stories', 'Outcome-led examples framed without unnecessary filler.', '/placements/success-stories.html'), ('Placement Contact', 'CDC team, coordinators, and recruiter-facing routes.', '/placements/contact.html'), ('Training Readiness', 'Aptitude, technical, communication, and interview-prep support described by SSETP.', '#')]},
    ...
    'placements/success-stories.html': {
        ...
        'hero_text': 'This page extends placement performance and recruiter ecosystem details without inventing fictional student profiles.',
        'hero_image': 'https://sseptp.org/assets/recruiters-B_A9F7qO.png',
        'content': [
            {'type': 'story_cards', 'kicker': 'Outcome lens', 'title': 'Three placement signals carry this page.', 'items': [('High-value offers', 'SSETP highlights strong top-end packages.'), ('Broad recruiter base', 'The number of recruiting companies signals scale, not just a few standout cases.'), ('Training-to-offer logic', 'Success stories connect back to the placement training model instead of reading like isolated testimonials.')]},
    ...
    'placements/contact.html': {
        ...
        'hero_text': 'SSETP names members of the CDC / Training & Placement team including Kiran Ravi Srivastava, Dr. Bala Koteswari, and Rakesh Yadav Kodari.',
        'hero_image': 'https://sseptp.org/assets/placement-D9x0hLK2.jpg',
        'content': [
            {'type': 'story_cards', 'kicker': 'Team visibility', 'title': 'This page has strong institutional source material.', 'items': [('CDC Head', 'Ms. Kiran Ravi Srivastava is named as CDC – Head.'), ('Coordinators', 'Dr. Bala Koteswari and Mr. Rakesh Yadav Kodari are visible as coordinators.'), ('Training layer', 'The team structure supports the broader placement-readiness narrative.')]},
...
SCRIPT = """const y=document.getElementById('year');if(y)y.textContent=new Date().getFullYear();const t=document.querySelector('.nav-toggle');const n=document.getElementById('site-nav');if(t&&n){const ensureMobilePanels=()=>{n.querySelectorAll('.nav-item.has-menu').forEach(i=>{const menu=i.querySelector('.nav-menu');if(!menu)return;let panel=i.querySelector('.nav-mobile-panel');if(window.innerWidth<=900){if(!panel){panel=document.createElement('div');panel.className='nav-mobile-panel';menu.querySelectorAll('.nav-menu-link').forEach(link=>panel.appendChild(link.cloneNode(true)));i.appendChild(panel)}}else if(panel){panel.remove()}})};const closeMenus=()=>{n.classList.remove('is-open');t.setAttribute('aria-expanded','false');n.querySelectorAll('.nav-item.is-open').forEach(i=>{i.classList.remove('is-open');const b=i.querySelector('.nav-parent');if(b)b.setAttribute('aria-expanded','false')})};ensureMobilePanels();t.addEventListener('click',e=>{e.stopPropagation();ensureMobilePanels();const o=n.classList.toggle('is-open');t.setAttribute('aria-expanded',String(o))});n.querySelectorAll('a').forEach(a=>a.addEventListener('click',()=>closeMenus()));n.querySelectorAll('.nav-parent').forEach(b=>b.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();ensureMobilePanels();const i=b.parentElement;const o=!i.classList.contains('is-open');n.querySelectorAll('.nav-item').forEach(x=>{x.classList.remove('is-open');const xb=x.querySelector('.nav-parent');if(xb)xb.setAttribute('aria-expanded','false')});if(o){i.classList.add('is-open');b.setAttribute('aria-expanded','true')}}));window.addEventListener('resize',()=>{ensureMobilePanels();if(window.innerWidth>900){n.querySelectorAll('.nav-item').forEach(i=>i.classList.remove('is-open'))}});document.addEventListener('click',e=>{if(!n.contains(e.target)&&!t.contains(e.target))closeMenus()})}"""
...
def render_hero(page_path: str, cfg: dict) -> str:
    ...
    if page_path in {'about/vision-mission.html','about/leadership.html','about/quality.html','about/industry-interface.html'}:
        labels = {
            'about/vision-mission.html': ('Vision focus', 'Purpose, values, and student-development intent are presented here as the institution’s direction.'),
...
def render_custom_sections(page_path: str) -> str:
    ...
    if page_path == 'placements/success-stories.html':
        return f'''<section class="section"><div class="container"><p class="section-label">Outcome lens</p><div class="section-head"><h2>Success stories stay close to placement proof.</h2><p>This page connects package levels, recruiter spread, and training-to-offer logic instead of inventing glossy profiles.</p></div><div class="cards cols-3 about-quality-grid"><article class="card"><div class="icon">01</div><h3>High-value offers</h3><p>SSETP highlights strong top-end packages.</p></article><article class="card card-featured"><div class="icon">02</div><h3>Broad recruiter base</h3><p>The number of recruiting companies matters because it signals scale, not just a few standout cases.</p></article><article class="card"><div class="icon">03</div><h3>Training-to-offer logic</h3><p>Success connects back to the placement-readiness model.</p></article></div></div></section>'''
    if page_path == 'placements/contact.html':
        return f'''<section class="section"><div class="container contact-grid"><article class="contact-card"><div class="icon">01</div><h3>CDC Head</h3><p>Ms. Kiran Ravi Srivastava</p><p>Listed as CDC – Head.</p></article><article class="contact-card"><div class="icon">02</div><h3>Coordinators</h3><p>Dr. Bala Koteswari</p><p>Mr. Rakesh Yadav Kodari</p></article><article class="contact-card"><div class="icon">03</div><h3>Routing</h3><p><a href="mailto:hr@sseptp.org">hr@sseptp.org</a></p><p>Recruiter and career-related queries</p></article></div></section><section class="section muted"><div class="container contact-layout"><div><p class="section-label">Employer route</p><h2>Recruiter contact is visible here without searching.</h2><p>This page acts as a direct career-cell access point linked to the wider placement proof.</p></div><div class="contact-panel"><h3>Best next steps</h3><p>Use the placements mailbox for recruiter contact</p><p>Review outcomes on the overview page</p><p>See proof framing in success stories</p></div></div></section>'''
    if page_path == 'about/vision-mission.html':
        return f'''<section class="section"><div class="container about-links"><div><p class="section-label">Institutional direction</p><h2>Vision and mission act here as the institution’s north star.</h2><p>This page highlights the school’s own language around character, initiative, innovation, teamwork, and social responsibility.</p></div><div class="about-link-list"><a href="{href_from(page_path, '/about/leadership.html')}"><strong>Leadership</strong><span>See how institutional voice supports the same direction.</span></a><a href="{href_from(page_path, '/about/quality.html')}"><strong>Quality & Recognition</strong><span>Connect purpose with visible quality signals and governance.</span></a></div></div></section>'''
    if page_path == 'about/leadership.html':
        return f'''<section class="section"><div class="container about-story-grid"><div class="about-portrait-wrap"><img class="about-portrait" src="https://sseptp.org/assets/principal-Cgd9y_bj.jpg" alt="SSETP leadership" /></div><div class="about-story-copy"><p class="section-label">Leadership voices</p><h2>Leadership messages strengthen trust for students and families.</h2><blockquote>Who leads the institution, how it speaks, and what it emphasizes are part of the admissions decision.</blockquote><p>The Chairman, Principal, and Secretary messages reinforce values, seriousness, and student confidence as part of the school’s leadership layer.</p></div></div></section>'''
    if page_path == 'about/quality.html':
        return f'''<section class="section"><div class="container"><p class="section-label">Core credentials</p><div class="section-head"><h2>Quality proof points are grouped clearly on this page.</h2><p>Autonomous status, AICTE and UGC recognition, NAAC, and IQAC sit together here as verifiable trust signals.</p></div><div class="cards cols-4 academic-program-grid"><article class="card"><div class="icon">01</div><h3>Autonomous Institute</h3><p>Academic independence is a key institutional proof point.</p></article><article class="card"><div class="icon">02</div><h3>AICTE Approved</h3><p>Programs are framed within the expected engineering approval structure.</p></article><article class="card"><div class="icon">03</div><h3>UGC Recognized</h3><p>Recognition contributes directly to trust and legitimacy.</p></article><article class="card"><div class="icon">04</div><h3>NAAC A Grade</h3><p>The institution highlights an A Grade with a 3.17 / 4 score.</p></article></div></div></section>'''
  ...
  <body class="page-shell page-{path.replace('/', '-').replace('.html', '').replace('index', 'overview')}">
      ...
      <section class="section">
        <div class="container cta-box">
          <div>
            ...
            <p>Explore the school through admissions, academics, campus, placements, and contact pathways built around SSETP’s real strengths.</p>
          </div>
    ...
    <footer class="site-footer">
      ...
      <div class="container footer-bottom">
        ...
        <p class="footer-note">Built around SSETP’s structure, original visual assets, and a clearer admissions-first experience.</p>
      </div>
    </footer>
