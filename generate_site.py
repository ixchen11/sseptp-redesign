...
def render_section_nav(page_path: str, section: str) -> str:
    ...
    return f'<section class="section-nav" aria-label="{escape(nav_label)}"><div class="container"><div class="section-nav-shell">{links}</div></div></section>'
