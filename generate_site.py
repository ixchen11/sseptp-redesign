...
PAGES = {
    ...
    'about/index.html': {
        ...
        'content': [
            {'type': 'feature_grid', 'variant': 'showcase', 'kicker': 'Inside About', 'title': 'The institutional story is now grouped the way visitors actually look for it.', 'text': 'The live site spans heritage, mission, leadership, recognition, advisory structures, and quality cells. Those pieces now work together instead of scattering attention.', 'cards': [
